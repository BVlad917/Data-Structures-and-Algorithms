...
void testFilter() {
	...
	assert(list.size() == 5);
	ListIterator it2 = list.first();
	assert(it2.getCurrent() == 212);
	it2.next();
	assert(it2.getCurrent() == 199);
	it2.next();
	assert(it2.getCurrent() == 157);
	it2.next();
	assert(it2.getCurrent() == 102);
	it2.next();
	assert(it2.getCurrent() == 101);
	it2.next();
	assert(it2.valid() == false);

	list = SortedIteratedList(asc);
	list.add(3);
	list.add(9);
	list.add(7);
	list.add(51);
